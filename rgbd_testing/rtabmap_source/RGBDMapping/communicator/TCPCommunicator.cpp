...
void Message::setMetaData(uint8_t messageType, uint32_t dataLength)
{
...
{
    setMetaData(messageType, dataLength);
    std::copy(messageContents, messageContents + dataLength, getStartOfData());
}
